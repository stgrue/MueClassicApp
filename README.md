...
Note: This app is for the **[classic version of Mü.](https://boardgamegeek.com/boardgame/152/mu-and-more)** A scoring app for the [Revised Edition](https://boardgamegeek.com/boardgame/429608/mu-and-more-revised-edition) is available at https://mue-form.pages.dev/.

Built with plain HTML, CSS, and JavaScript; with generous help from [Claude Code](https://code.claude.com/docs/en/overview).

## Usage

Open `index.html` in any browser, or visit the live version on [GitHub Pages](https://stgrue.github.io/MueClassicApp/).
